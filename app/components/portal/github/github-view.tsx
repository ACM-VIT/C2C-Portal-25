...
import { getInstallUrlAction, listInstallationReposAction, saveInstallationAction } from '@/app/actions/github';
  ...
  return (
    <div className="fixed inset-0 w-screen h-screen relative text-white">
      ...
      <div className="absolute inset-0 overflow-auto p-6">
        ...
        <h1 className="text-3xl mb-4" style={{ fontFamily: "'Pilat Extended', Arial, sans-serif" }}>GitHub Integration</h1>
